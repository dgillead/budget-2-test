...
if Budget.check_if_budget_exists == 0
	...
	puts "Would you like to see your current budget limit, change the current budget limit, modify or see category limits, or modify or see transactions? \n
    - see \n
    - change \n
    - category \n
    - transaction"
	response = gets.chomp
	if response.downcase == 'see'
		puts 'Current budget limit:'
